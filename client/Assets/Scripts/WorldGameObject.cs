...
public class WorldGameObject : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        m_playerCam = Player.GetComponent<Camera>();
    ...
    private void ProcessPlayerInput()
    {
        ...
        {
            Player.transform.Translate(Vector3.forward * Time.deltaTime * textspeed);
        }
        else if (Input.GetKey(KeyCode.S))
        {
            Player.transform.Translate(Vector3.back * Time.deltaTime * textspeed);
        }
        else if (Input.GetKey(KeyCode.A))
        {
            Player.transform.Translate(Vector3.up * Time.deltaTime * textspeed);
        }
        else if (Input.GetKey(KeyCode.D))
        {
            Player.transform.Translate(Vector3.down * Time.deltaTime * textspeed);
        }
