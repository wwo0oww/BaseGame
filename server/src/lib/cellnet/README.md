...
[1]: https://godoc.org/lib/cellnet?status.svg
[2]: https://godoc.org/lib/cellnet
[3]: https://travis-ci.org/davyxu/cellnet.svg?branch=master
[4]: https://travis-ci.org/davyxu/cellnet
[5]: https://goreportcard.com/badge/lib/cellnet
[6]: https://goreportcard.com/report/lib/cellnet
...
* cellnet内建支持以下数据编码:
    ...
    - 二进制协议(https://lib/goobjfmt)

       内存流直接序列化, 适用于服务器内网传输

    - ProtoPlus(https://lib/protoplus)
...
* 支持混合编码收发
    ...
    - 与Unity3D(C#)使用ProtoPlus(lib/protoplus)协议通信
...
```
  go get -u -v lib/cellnet

  go get -u -v lib/golog

  go get -u -v lib/goobjfmt

  go get -u -v lib/protoplus
```

# 第三方库

cellnet 使用Protobuf时，需要使用附带的pb插件生成一个绑定代码，下面的链接可以处理这个问题
[Google Protobuf 编码安装](https://lib/cellnet/blob/master/doc/pbcodec.md)
...
[目录及功能一览](https://lib/cellnet/blob/master/doc/dirstruct.md)
...
那么 cellnet结构位于 /home/you/go/src/lib/cellnet
...
* [队列](https://lib/cellnet/blob/master/doc/queue.md)

* [端(Peer)](https://lib/cellnet/blob/master/doc/peer.md)

* [收发处理消息](https://lib/cellnet/blob/master/doc/procmsg.md)
...
* [定制封包编码(Codec)](https://lib/cellnet/blob/master/doc/customcodec.md)

    封包编码可以是JSON，Protobuf等

* [定制端(Peer)](https://lib/cellnet/blob/master/doc/custompeer.md)

    新增Redis连接器，与cellnet自带的TCP/UDP的Peer都不同。

* [定制处理器(Processor)](https://lib/cellnet/blob/master/doc/customproc.md)

    需要在收发包时有统一的处理行为

# FAQ

[常见问题及回答](https://lib/cellnet/blob/master/doc/faq.md)
...
# 版本历史
2018.5  v4版本 [详细请查看](https://lib/cellnet/blob/v4/CHANGES.md)

2017.8  v3版本 [详细请查看](https://lib/cellnet/blob/v3/CHANGES.md)

2017.1  v2版本 [详细请查看](https://lib/cellnet/blob/v2/CHANGES.md)
...
提交bug及特性: https://lib/cellnet/issues
